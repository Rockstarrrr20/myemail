...
public class sent extends HttpServlet 
{
            ...
            throws ServletException, IOException 
    {
           ...
           try
           {
            ps=co.prepareStatement("select * from sent where frm=? ");
            ps.setString(1, s1);
             rs=ps.executeQuery();
             pw.print("<html>\n" +
"    <body>\n" +
...
pw.print("<td width=\"60%\" height=\"300\">\n<form action=delete>");
               while(rs.next())
             {
               pw.print("<input type=checkbox name=ch value="+rs.getString(1)+">"+rs.getString(2)+"|"+"<a href=opens?inid="+rs.getString(1)+">"+rs.getString(4)+"</a>");
               pw.print("<hr>");
             }
